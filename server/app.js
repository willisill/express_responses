...
app.get('/viewers/:id', (req, res) => {
    ...
    const user = {
        ...
        lastName: 'Weimar',
        birthDate: 'you wish',
        favoriteMovies: ['Godfather', 'Home Alone', 'Jeepers Creepers']
    };
...
app.post('/movies', (req, res) => {
    ...
    const movie = {
        id: Math.floor(Math.random() * 10000000), // Generating a random ID
        name,
        year: parseInt(year), // Converting year to an integer
        isFavorite: favorite === 'on' ? true : false // Checking if favorite is 'on'
    };
